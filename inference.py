...
def stream_generate_answer(
    ...
    generation_kwargs = dict(
        ...
        streamer=streamer,
        eos_token_id=tokenizer.convert_tokens_to_ids("<|im_end|>"),  # 强制指定
...
def main():
    ...
    parser.add_argument('--stop_str', default="<|im_end|>", type=str)
    ...
    stop_str = args.stop_str or "<|im_end|>"  # Use default stop string
